...
//             >
//               Don’t settle for average. Partner with us to build digital systems
//               that truly set your industry’s standard.
//             </motion.p>
...
//             {/* Overlapping Rounded Image 1 (Small, Squircle) */}
//             <motion.div
...
//             {/* Overlapping Rounded Image 2 (Circle) */}
//             <motion.div
//               initial={{ opacity: 0, scale: 0.5, x: 100, y: -100 }}
//               whileInView={{ opacity: 1, scale: 1, x: 0, y: 0 }}
//               viewport={{ once: true }}
